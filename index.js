...
var __requireFun = function(parModule){
    ...
    if (promiseland._hasModule({ hashStr: "7e2cc08b814e254b22fbd881f0462f24" })){ return promiseland._getModule("7e2cc08b814e254b22fbd881f0462f24"); };
var PL$1 = new __Promise();
promiseland._registerModule({ hashStr: "7e2cc08b814e254b22fbd881f0462f24", "module": PL$1, promising: true });
...
PL$3/*promiseland exception catcher*/(function(){
  ...
  PL$7/*try catch*/(function(){
    ...
    PL$11/*program*/["version"]("0.0.1")["option"]("-p, --port [number]", "port number")["parse"](PL$13/*process*/["argv"]);
    PL$14/*dirs*/ = [
      "app", 
      "Broadway", 
      "libde265.js"
